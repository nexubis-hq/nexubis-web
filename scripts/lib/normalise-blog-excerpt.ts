...
export function normaliseBlogExcerpt(value: string, maxLength = MAX_EXCERPT_LENGTH) {
...
export function blogExcerptLength(value: string) {
  return normaliseBlogExcerpt(value).length;
}
