...
const expectedNames = {
  ...
  tags: {
    ...
    [ids.tags.sourceScorecard]: "Source: Nexubis | Audit",
    [ids.tags.sourceContactForm]: "Source: Nexubis | Contact Form",
    [ids.tags.triggerSales]: "Trigger: Nexubis | Start Audit Sales",
    ...
    [ids.tags.historySales]: "History: Nexubis | Audit Sales Started",
